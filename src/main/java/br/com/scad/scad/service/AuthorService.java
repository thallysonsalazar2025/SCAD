...
public class AuthorService {
    ...
    public AuthorService(AuthorRepository authorRepository, AuthorMapper authorMapper, ValidateAuthor validateAuthor, SecurityService securityService, UserMapper userMapper) {
